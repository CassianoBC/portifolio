...
export const DATA = {
  ...
  contact: {
    email: "Cassianocosta12357@gmail.com",
    tel: "+55 (51)99889-3255",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/CassianoBC",
        icon: Icons.github,
      ...
      X: {
        name: "X",
        url: "https://x.com/CassianoCosta0",
        icon: Icons.x,
      ...
      Youtube: {
        name: "Youtube",
        url: "https://www.youtube.com/@cassiano8842",
        icon: Icons.youtube,
        navbar: true,
      },
      email: {
  ...
  projects: [
    {
      ...
      href: "https://autelar-automacao.vercel.app",
      dates: "Jan 2026",
      active: true,
      description:
        "Site feito com Next.js. Trata-se de uma empresa de automação residencial.",
      technologies: [
        "Next.js",
        "Typescript",
        "TailwindCSS",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/CassianoBC/autelar-automacao",
          icon: <Icons.github className="size-3" />,
        }
      ],
      image: "/autelar-site.png",
      video:
        "",
    },
  ],
